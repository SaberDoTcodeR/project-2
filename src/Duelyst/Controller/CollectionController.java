...
public class CollectionController {
    ...
    public void importAct() {
        Gson gson = new Gson();
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\saber\\IdeaProjects\\projecctt\\src\\Duelyst\\model\\Save\\deck.json"));
    ...
    public void exportAct() {
        ...
        try {
            ...
            FileWriter writer = new FileWriter("C:\\Users\\saber\\IdeaProjects\\projecctt\\src\\Duelyst\\model\\Save\\deck.json");
            writer.write(json);
            writer.close();
        } catch (
                IOException e) {

...
public class Rakhsh extends Hero {
    public Rakhsh() {
        ...
        super.setMp(1);
        super.cardImage = new Image("DuelystClient/css/unit_gifs/f1_bromemk2_breathing.gif");
    }
    ...
    public Hero duplicate() {
        ...
        rakhsh.cardImage = new Image("DuelystClient/css/unit_gifs/f1_bromemk2_breathing.gif");
        return rakhsh;
    }

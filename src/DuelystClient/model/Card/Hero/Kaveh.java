...
public class Kaveh extends Hero {
    public Kaveh() {
        ...
        super.setMp(1);
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_wujin_breathing.gif");
    }
    ...
    public Hero duplicate() {
        ...
        kaveh.cardImage = new Image("DuelystClient/css/unit_gifs/boss_wujin_breathing.gif");
        return kaveh;
    }

...
public class Madness extends Spell {
    ...
    public Madness() {
        super("Madness", 0, 650);
        super.cardImage = new Image("DuelystClient/css/unit_gifs/f6_faiefestive_breathing.gif");
    }
    ...
    public Spell duplicate() {
        ...
        madness.cardImage = new Image("DuelystClient/css/unit_gifs/f6_faiefestive_breathing.gif");
        return madness;
    }

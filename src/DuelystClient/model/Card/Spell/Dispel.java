...
public class Dispel extends Spell {
    ...
    public Dispel() {
        super("Dispel", 0, 2100);
        super.cardImage = new Image("DuelystClient/css/unit_gifs/f3_zirixfestive_breathing.gif");
    }
    ...
    public Spell duplicate() {
        ...
        dispel.cardImage = new Image("DuelystClient/css/unit_gifs/f3_zirixfestive_breathing.gif");
        return dispel;
    }

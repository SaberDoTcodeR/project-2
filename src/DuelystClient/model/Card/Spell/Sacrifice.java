...
public class Sacrifice extends Spell {
    ...
    public Sacrifice() {
        ...
        super.cardImage=new Image("DuelystClient/css/unit_gifs/f6_tier2general_breathing.gif");
    }
    ...
    public Spell duplicate() {
        ...
        sacrifice.cardImage = new Image("DuelystClient/css/unit_gifs/f6_tier2general_breathing.gif");
        return sacrifice;
    }

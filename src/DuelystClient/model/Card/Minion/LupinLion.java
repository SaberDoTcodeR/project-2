...
public class LupinLion extends Minion {
    public LupinLion() {
        ...
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_harmony_breathing.gif");
    }
    ...
    public Minion duplicate() {
        ...
        lupinLion.cardImage = new Image("DuelystClient/css/unit_gifs/boss_harmony_breathing.gif");
        return lupinLion;
    }

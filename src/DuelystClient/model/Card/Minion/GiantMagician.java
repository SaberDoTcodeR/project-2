...
public class GiantMagician extends Minion {
    public GiantMagician() {
        ...
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_decepticlesword_breathing.gif");
    }
    ...
    public Minion duplicate() {
        ...
        giantMagician.cardImage = new Image("DuelystClient/css/unit_gifs/boss_decepticlesword_breathing.gif");

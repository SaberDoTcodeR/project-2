...
public class TwoHeadGiant extends Minion {
    public TwoHeadGiant() {
        ...
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_taskmaster_breathing.gif");
    }
    ...
    public Minion duplicate() {
        ...
        twoHeadGiant.cardImage = new Image("DuelystClient/css/unit_gifs/boss_taskmaster_breathing.gif");
        return twoHeadGiant;
    }

...
public class Bahman extends Minion {
    public Bahman() {
        ...
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_borealjuggernaut_breathing.gif");
    ...
    public Minion duplicate() {
        ...
        bahman.cardImage = new Image("DuelystClient/css/unit_gifs/boss_borealjuggernaut_breathing.gif");
        return bahman;
    }

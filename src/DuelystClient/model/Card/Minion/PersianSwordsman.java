...
public class PersianSwordsman extends Minion {
    public PersianSwordsman() {
        ...
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_paragon_breathing.gif");
    }
    ...
    public Minion duplicate() {
        ...
        persianSwordsman.cardImage = new Image("DuelystClient/css/unit_gifs/boss_paragon_breathing.gif");

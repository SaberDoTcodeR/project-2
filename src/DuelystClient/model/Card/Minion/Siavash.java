...
public class Siavash extends Minion {
    public Siavash() {
        ...
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_serpenti_breathing.gif");
    }
    ...
    public Minion duplicate() {
        ...
        siavash.cardImage = new Image("DuelystClient/css/unit_gifs/boss_serpenti_breathing.gif");
        return siavash;
    }

...
public class TuranianPrince extends Minion {
    public TuranianPrince() {
        ...
        super.cardImage = new Image("DuelystClient/css/unit_gifs/boss_skurge_breathing.gif");
    }
    ...
    public Minion duplicate() {
        ...
        turanianPrince.cardImage = new Image("DuelystClient/css/unit_gifs/boss_skurge_breathing.gif");

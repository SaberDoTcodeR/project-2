...
*/
    ...
    */}
    ...
    private void showCard(String cardName, int type) {//0 hero 1 minion 2 spell 3 item
        ...
        ImageView imageView;
        if (type == 0) {
            imageView = new ImageView(new Image("DuelystClient/css/heroDeck.jpg"));
        } else if (type == 1) {
            imageView = new ImageView(new Image("DuelystClient/css/minionDeck.jpg"));
        } else if (type == 2) {
            imageView = new ImageView(new Image("DuelystClient/css/spellDeck.jpg"));
        } else {
            imageView = new ImageView(new Image("DuelystClient/css/itemDeck.jpg"));
        }
    ...
    */}
    ...
    public void exportAct() {
        ...
        try {
            ...
            if (currentDeck != null) {
                saveDeck.name = currentDeck.getName();
                currentDeck.getHero().forEach(y -> saveDeck.cards.add(y.getName()));
                currentDeck.getMinions().forEach(y -> saveDeck.cards.add(y.getName()));
                currentDeck.getSpells().forEach(y -> saveDeck.cards.add(y.getName()));
